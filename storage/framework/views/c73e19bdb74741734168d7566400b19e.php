...
<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-orange-50/50">
    <div>
        <a href="/" class="flex flex-col items-center gap-2 group">
            ...
            <span class="font-bold text-3xl text-orange-600 tracking-tight">ISI<span class="text-gray-900">BURGER</span></span>
        </a>
    </div>
    ...
    <p class="mt-8 text-gray-400 text-sm">
        &copy; <?php echo e(date('Y')); ?> ISI Burger - Le goût avant tout.
    </p>
</div>
</body>
</html>
<?php /**PATH C:\Users\fafad\Herd\isi-burger\resources\views/layouts/guest.blade.php ENDPATH**/ ?>