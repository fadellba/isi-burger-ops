...
<head>
    ...
    <title><?php echo e(config('app.name', 'ISI Burger')); ?> - Les meilleurs burgers de la ville</title>
...
<body
    class="antialiased bg-gray-50 text-gray-900 font-['Instrument_Sans'] selection:bg-orange-500 selection:text-white no-scrollbar overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            <div class="flex-shrink-0 flex items-center gap-2">
                ...
                <span class="font-bold text-2xl text-orange-600 tracking-tight">ISI<span
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-orange-600 font-medium transition">Connexion</a>
                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-md shadow">
                                <a href="<?php echo e(route('customer.catalogues.index') ?? '#'); ?>"
    ...
    <section id="menu" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <?php if($category->burgers->count() > 0): ?>
                        <div>
                            <div class="flex items-center gap-4 mb-8">
                                <h3 class="text-xl font-bold text-gray-800 uppercase tracking-widest"><?php echo e($category->nom); ?></h3>
                                <div class="h-px bg-gray-100 flex-1"></div>
                            </div>

                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                                <?php $__currentLoopData = $category->burgers->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $burger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <div class="group relative bg-gray-50 rounded-3xl p-4 transition-all hover:bg-white hover:shadow-2xl border border-transparent hover:border-orange-100">
                                    <div class="aspect-square overflow-hidden rounded-2xl mb-4 bg-white">
                                        <?php if($burger->image): ?>
                                            <img src="<?php echo e(asset('storage/' . $burger->image)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                                        <?php else: ?>
                                            <div class="w-full h-full flex items-center justify-center text-5xl">🍔</div>
                                        <?php endif; ?>
                                    </div>

                                    <h4 class="text-lg font-bold text-gray-900"><?php echo e($burger->nom); ?></h4>
                                    <p class="text-sm text-gray-500 mt-1 line-clamp-2"><?php echo e($burger->description); ?></p>

                                    <div class="mt-4 flex items-center justify-between">
                                        <span class="text-xl font-black text-orange-600"><?php echo e(number_format($burger->unit_price, 0, ',', ' ')); ?> F</span>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('login')); ?>" class="text-xs font-bold text-gray-400 hover:text-orange-600 underline">Connectez-vous</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <div class="mt-16 text-center">
                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-gray-900 hover:bg-orange-600 transition shadow-xl">
    ...
    <div id="concept" class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-base text-orange-600 font-semibold tracking-wide uppercase">La différence ISI</h2>
...
<footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="flex justify-center items-center gap-2 mb-4">
            <span class="text-2xl">🍔</span>
            <span class="font-bold text-2xl tracking-tight">ISI<span class="text-orange-500">BURGER</span></span>
        </div>
        <p class="text-gray-400 mb-6">La référence du burger artisanal.</p>
        <p class="text-sm text-gray-500">
            &copy; <?php echo e(date('Y')); ?> ISI Burger. Tous droits réservés.
        </p>
    </div>
</footer>
...
<?php /**PATH C:\Users\fafad\Herd\isi-burger\resources\views/welcome.blade.php ENDPATH**/ ?>