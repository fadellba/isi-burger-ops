...
<head>
    ...
    <title><?php echo e(config('app.name', 'ISI Burger')); ?></title>
...
<footer class="mt-20 border-t border-slate-100 py-10 text-center text-slate-400 text-sm">
    &copy; <?php echo e(date('Y')); ?> ISI Burger - Le goût du vrai.
</footer>
</body>
</html>
<?php /**PATH C:\Users\fafad\Herd\isi-burger\resources\views/layouts/customer-layout.blade.php ENDPATH**/ ?>