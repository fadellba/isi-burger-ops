...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center w-full">
            ...
            <a href="<?php echo e(route('manager.burgers.create')); ?>"
                ...
                <?php $__currentLoopData = $burgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $burger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="p-4 font-semibold text-slate-600">
                            <?php echo e(number_format($burger->unit_price, 0, ',', ' ')); ?> <span class="text-xs font-normal text-slate-400">FCFA</span>
                        </td>
                        ...
                        <td class="p-4">
                            ...
                            ?>
                            <div class="flex items-center gap-3">
                                <span class="font-black text-slate-800 text-lg w-8"><?php echo e($burger->stock); ?></span>
                                <span class="px-2 py-0.5 rounded-full text-[10px] uppercase font-bold border <?php echo e($stockColor); ?>">
                                        <?php echo e($label); ?>
                        ...
                        <td class="p-4 text-right pr-6">
                            <div class="flex justify-end gap-2">
                                <a href="<?php echo e(route('manager.burgers.edit', $burger)); ?>"
                                ...
                                <a href="#archive-<?php echo e($burger->id); ?>"
                            ...
                            <div id="archive-<?php echo e($burger->id); ?>" class="fixed inset-0 z-50 invisible target:visible flex items-center justify-center bg-slate-900/60 backdrop-blur-sm transition-all">
                                <div class="bg-white p-8 rounded-3xl shadow-2xl max-w-sm w-full mx-4 transform transition-all">
                                    <div class="text-center">
                                        ...
                                        <p class="text-slate-500 mb-6 text-sm">
                                            Le burger <strong><?php echo e($burger->nom); ?></strong> ne sera plus visible par les clients.
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <form action="<?php echo e(route('manager.burgers.destroy', $burger)); ?>" method="POST" class="flex-1">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\fafad\Herd\isi-burger\resources\views/manager/burgers/index.blade.php ENDPATH**/ ?>