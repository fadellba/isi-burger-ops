{{--
Guide pour créer un graphique avec Chart.js :
1. Inclure la bibliothèque
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>

2. Ajouter l'élément Canvas
Insérez une balise <canvas> dans votre corps HTML avec un identifiant unique (id) pour que JavaScript puisse le cibler.
<canvas id="monGraphique"></canvas>

3. Récupérer le contexte du Canvas
sélectionnez l'élément et récupérez son contexte de rendu 2D.
const ctx = document.getElementById('monGraphique').getContext('2d');

4. Initialiser le graphique
Créez une nouvelle instance de l'objet Chart en passant le contexte et un objet de configuration.
Type : Définissez le format (ex: 'bar', 'line', 'pie', 'Sankey / Funnel',
'Box Plot', 'Financial', 'Mixed', 'Bubble', 'Scatter', 'Polar Area', 'Radar', ' Doughnut').
Data : Fournissez les labels (axes) et les datasets (valeurs, couleurs de fond et de bordure).
Options : Personnalisez l'affichage, comme les échelles (scales) ou la légende.
